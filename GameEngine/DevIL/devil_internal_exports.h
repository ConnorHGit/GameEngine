...
#define IL_MIN(a,b) (((a) < (b)) ? (a) : (b))
	...
	ILAPI
	void ILAPIENTRY ifree(const void* Ptr);
	ILAPI
...
ILAPI void* ILAPIENTRY ivec_align_buffer(void *buffer, const ILuint size);
	...
	ILAPI
	void ILAPIENTRY ilSetCurImage(ILimage * Image);
	ILAPI
	void ILAPIENTRY ilSetError(ILenum Error);
	ILAPI
	void ILAPIENTRY ilSetPal(ILpal* Pal);
	...
	ILAPI
	void ILAPIENTRY ilReplaceCurImage(ILimage * Image);
	ILAPI
	void ILAPIENTRY iMemSwap(ILubyte*, ILubyte*, const ILuint);
	...
	ILAPI
	void ILAPIENTRY ilCloseImage(ILimage * Image);
	ILAPI
	void ILAPIENTRY ilClosePal(ILpal* Palette);
	...
	ILAPI
	void ILAPIENTRY ilGetClear(void* Colours, ILenum Format, ILenum Type);
	...
	ILAPI
	void *ILAPIENTRY ilConvertBuffer(ILuint SizeOfData, ILenum SrcFormat, ILenum DestFormat, ILenum SrcType, ILenum DestType, ILpal* SrcPal, void* Buffer);
